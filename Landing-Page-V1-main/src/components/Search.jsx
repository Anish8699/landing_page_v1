  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex flex-col items-center  md:flex-row gap-[10px]">
        ...
        <button className="bg-[#1B95AC] text-white rounded-3xl py-[16px] px-[32px] h-[54px] flex gap-x-[10px] items-center justify-center" style={{}}>
          <span style={{borderRadius:"24px",padding:"60px 162px 60px 162px",gap:"20px",color:"#59B7E9"}}>Join now</span> <MdArrowOutward />
        </button>
      </div>
    </div>
  );
