...
const Community = () => {
  return (
    <div data-aos="fade-up" className="flex flex-col items-center justify-center text-center md:text-inherit gap-y-9 py-[60px] bg-[#272727] w-full rounded-xl mb-36 md:mb-44 relative">
      <h1 className="text-3xl md:text-[64px] text-[#ffffff] md:max-w-[70%] font-bold " style={{fontWeight:"700",fontSize:"55px",lineHeight:"73.7px"}}>
        Join our Community
      </h1>
      <p className="text-[#ffffffbe] text-[21px] md:text-[24px]" style={{fontWeight:"400",fontSize:"24px",lineHeight:"36px",alignItems:"center"}}>Become part of a vibrant ecosystem of innovators and collaborators</p>
