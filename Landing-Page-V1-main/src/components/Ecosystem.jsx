  ...
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center w-full gap-y-11">
        <h1 className="text-3xl md:text-[64px] text-center text-[#ffffff]  font-bold  md:leading-[73px]" style={{fontWeight:"700",fontSize:"55px",lineHeight:"73.7px",alignItems:"center"}}>
          Complete Ecosystem
        </h1>
        <p className="text-[rgba(255,255,255,1)] text-[26px] text-center" style={{fontWeight:"400",fontSize:"26px",lineHeight:"39px",alignItems:"center"}}>
