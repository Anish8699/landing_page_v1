...
const Navbar = () => {
  ...
  return (
    <div className="hidden md:flex items-center justify-center w-screen border-b border-[#1D1D1D] py-[20px] px-[20px]">
      <div className="flex  items-center justify-between w-full text-[#fff] max-w-screen-sm px-5 md:max-w-screen-md lg:max-w-screen-lg xl:max-w-screen-xl" style={{marginTop:"52px"}}>
