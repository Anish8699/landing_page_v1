    ...
    <div className="relative flex items-center justify-center w-full mb-[109px]">
      <div data-aos="fade-up" className="flex flex-col w-full gap-y-[50px] ">
        <h1 className="text-3xl text-center md:text-[55px] text-[#ffffff]  font-bold md:leading-[73px]">
         <span style={{fontWeight:"600",fontSize:"55px",lineHeight:"73.7px",alignItems:"center",color:"#F8CE62"}}>
         Your one-stop shop
         </span>
         <br/>
        <div style={{fontWeight:"600",fontSize:"55px",lineHeight:"73.7px"}}>
        for secure and reliable dApps, tokens, and service
          providers in the Solana blockchain.
        </div>
         <br/>
        </h1>

        <div className="relative w-full overflow-y-hidden h-[390px] marquee" >
          <div className="absolute flex w-full h-full marquee--inner scroll-m-0" style={{width:"426px",height:"900px",gap:"12px",padding:"36px",border:"0.5px"}}>
            ...
            <div className="orb w-[400px] min-w-[400px]  py-8 px-7 text-[#fff] flex flex-col gap-y-5 border-y-[0.1px] border-gray-500 border-l-[0.1px] bg-[#272727]" >
              ...
              <div className="flex flex-col gap-y-4">
                <h3 className="text-[21px] md:text-[24px] font-semibold" style={{}}>
                  Developers
                </h3>
                <p style={{fontWeight:"400",fontSize:"16px",lineHeight:"24px"}}>
