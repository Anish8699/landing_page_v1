    ...
    >
      <div className="flex flex-col items-center justify-center w-full">
        <span className="text-4xl md:text-[64px] text-[#ffffff] md:max-w-[70%] mb-4 font-bold md:space-y-[16px] md:leading-[73px]">
          <h1 className="" style={{fontWeight:"400",fontSize:"64px",lineHeight:"87.3px",alignItems:"center"}}>
            Your Gateway
            <br className="hidden md:block" style={{fontWeight:"400",fontSize:"26px",lineHeight:"39px",alignItems:"center"}} /> to the Solana Ecosystem
          </h1>
        </span>
      ...
      <div>
        <button
          ...
          style={{width:"176px",height:"46px",borderRadius:"10px",padding:"12px 24px 12px 24px",gap:"10px"}}
          >
          Learn More
        </button>
        <div  
